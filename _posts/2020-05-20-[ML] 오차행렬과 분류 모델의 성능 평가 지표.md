...
![confusion]({{site.baseurl}}/img/confusion.png){: width="300"}{: .center}
...
![roccurve]({{site.baseurl}}/img/roccurve.png){: width="300"}{: .center}
...
![auc]({{site.baseurl}}/img/auc.png){: width="300"}{: .center}
