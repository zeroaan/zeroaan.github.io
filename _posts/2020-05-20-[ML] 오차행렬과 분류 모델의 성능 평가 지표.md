...
![confusion]({{site.baseurl}}/img/confusion.png){: width="30%" height="30%"}
...
![roccurve]({{site.baseurl}}/img/roccurve.png){: width="30%" height="30%"}
...
![auc]({{site.baseurl}}/img/auc.png){: width="30%" height="30%"}
