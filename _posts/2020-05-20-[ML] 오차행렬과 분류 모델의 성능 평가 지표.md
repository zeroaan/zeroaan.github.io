...
![confusion]({{site.baseurl}}/img/confusion.png){: width="60%" height="60%"}
...
![roccurve]({{site.baseurl}}/img/roccurve.png){: width="60%" height="60%"}
...
![auc]({{site.baseurl}}/img/auc.png){: width="60%" height="60%"}
